...
| Q6 | **Forbidden-claims linting:** a deny-list (and pattern rules) checked at draft time — no ROI promises we can't back, no competitor disparagement, no "free forever" phrasing that contradicts §4-of-PRD pricing triggers, no implied endorsements. | The agent must be incapable of overpromising. Marketing copy errors in a contract-adjacent domain (booking, money) become support debt and legal exposure. |
